...
public class TMapService {
    ...
    public String getDrivingTime(String startX, String startY, String endX, String endY, String departureTime) {
    ...
    public String getWalkingTime(String startX, String startY, String endX, String endY, int speed) {
